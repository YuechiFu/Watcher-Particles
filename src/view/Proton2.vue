...
onMounted(() => {
  ...
  function loadImage() {
    ...
    logo[0] = loader.addImage("/S.png");
    logo[1] = loader.addImage("/S.png");
    logo[2] = loader.addImage("/S.png");
  ...
  function initBehaviours() {
    ...
    rect = new Proton.Rectangle(
      ...
      (canvas.height - imageWidth) / 2,
      imageWidth,
      imageWidth
    );
    rect2 = new Proton.Rectangle(
      (canvas.width - drawScopeWidth) / 2,
      0,
      drawScopeWidth,
      canvas.height
    );
  ...
  function createProton() {
    ...
    emitter.addBehaviour(
      customToZoneBehaviour(logoZone[0], logoZone[1], logoZone[2])
    );
  ...
  function mouseDownHandler(e) {
    rootIndex++;
    if (rootIndex % 2 == 0) {
      if (rootIndex % 6 == 2) gravityBehaviour.reset(9);
      else if (rootIndex % 6 == 4) randomBehaviour.reset(30, 30, 0.001);
      else
